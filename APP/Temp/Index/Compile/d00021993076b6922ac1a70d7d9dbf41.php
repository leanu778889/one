...
<div class="bodyer">
    ...
    <div class="banner" >
		  <div id="banner">
            ...
            <div id="banner_list">
            <a href="###" target="_blank"><img src="public/images/banner.png" width="320" height="163" alt="" /></a>
            <a href="###" target="_blank"><img src="public/images/banner.png" width="320" height="163" alt="" /></a>
            <a href="###" target="_blank"><img src="public/images/banner.png" width="320" height="163" alt="" /></a>
            <a href="###" target="_blank"><img src="public/images/banner.png" width="320" height="163" alt="" /></a>
            </div>
    ...
    <div class="list">
    	<ul>
        	<li>
            	<dl>
                	<dt><img src="Public/images/laba.png" height="5" width="6"></dt>
            ...
            <li>
            	<dl>
                	<dt><img src="Public/images/laba.png"></dt>
                    <dd>苏有朋称相亲是侮辱 将赴印度修行10天</dd>
                </dl>
            </li>
    ...
    <div class="appbtn">
    	<div class="APPleft">
        	<div class="top_j"><h3>剧组信息</h3></div>
            <div class="btm"><h3>演员信息</h3></div>
        </div>
